...
def main():
    ...
    # IO
    p.add_argument("--save-dir", type=str, default="runs/lstm_baseline")
    ...
    # Extended-style artifacts to mirror the extended model outputs
